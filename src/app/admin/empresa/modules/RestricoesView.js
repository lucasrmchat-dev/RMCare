                    ...
                    <section>
                      ...
                      <div className="grid md:grid-cols-2 gap-4 mb-6">
                        <button 
                          ...
                          className={`p-6 rounded-2xl border-2 transition-all flex flex-col gap-3 text-left ${tipoRegra === "geral" ? "border-zinc-900 bg-zinc-50 shadow-md" : "border-zinc-200 hover:border-zinc-300 bg-white"}`}
                        >
                        ...
                        <button 
                          ...
                          className={`p-6 rounded-2xl border-2 transition-all flex flex-col gap-3 text-left ${tipoRegra === "especifica" ? "border-zinc-900 bg-zinc-50 shadow-md" : "border-zinc-200 hover:border-zinc-300 bg-white"}`}
                        >
            ...
            <motion.div key="lista" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} transition={spring}>
              {regras.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {regras.map((regra) => {
                    const profissional = regra.servico_id 
                        ? (servicosOptions.find(s => s.value === regra.servico_id) || { label: "Profissional Desconhecido" })
                        : { label: "Regra Geral da Clínica" };
