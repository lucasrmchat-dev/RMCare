                ...
                <div className="w-full md:w-[320px] border-r border-zinc-100 dark:border-white/5 p-6 flex flex-col overflow-y-auto bg-white/40 dark:bg-[#0a0a0d]/40">
                  ...
                  <div className="grid grid-cols-7 gap-y-2 gap-x-1">
                    {["D", "S", "T", "Q", "Q", "S", "S"].map((d, i) => (
                      <div key={i} className="text-center text-[10px] font-extrabold text-zinc-400 uppercase">
                        {d}
                      </div>
                    ))}
                              ...
                              {!isCanceled && (
                                <>
                                  <button
                                    ...
                                    className="min-h-[42px] px-3.5 py-2 rounded-xl border border-zinc-200/80 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-900 flex items-center gap-1.5 text-xs font-bold transition-colors"
                                  >
                                    <RotateCcw size={14} className="text-[#86a621] dark:text-[#9FC131]" /> Remarcar
                                  </button>
                                  <button
                                    onClick={() => {
                                      playDopamineSound("click");
                                    ...
                                    className="min-h-[42px] px-3.5 py-2 rounded-xl bg-red-500/10 text-red-600 dark:text-red-400 border border-red-500/20 hover:bg-red-500/20 flex items-center gap-1.5 text-xs font-bold transition-colors"
                                  >
                                ...
                                {item.statusAtendimento !== "cancelado" && (
                                  <>
                                    <button
                                      ...
                                      className="min-h-[36px] px-3 py-1.5 border border-zinc-200 text-zinc-700 dark:text-zinc-300 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 text-[11px] font-bold"
                                    >
                                      Remarcar
                                    </button>
                                    <button
                                      ...
                                      className="min-h-[36px] p-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-xl transition-colors"
                                      title="Cancelar"
                                    >
                                      <Trash2 size={15} />
                                    </button>
                            ...
                            {!isCanceled && (
                              <>
                                <button
                                  ...
                                  className="min-h-[42px] px-3.5 py-2 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-xl text-xs font-bold hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors flex items-center gap-1.5"
                                >
                                  <RotateCcw size={14} className="text-[#86a621] dark:text-[#9FC131]" /> Remarcar
                                </button>
                                <button
                                  ...
                                  className="min-h-[42px] px-3.5 py-2 bg-red-500/10 text-red-600 dark:text-red-400 border border-red-500/20 rounded-xl text-xs font-bold hover:bg-red-500/20 transition-colors flex items-center gap-1.5"
                                >
                                  <Trash2 size={14} /> Cancelar
                                </button>
                              </>
          ...
          >
            ...
            >
              ...
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl text-xs text-amber-800 dark:text-amber-300 flex items-start gap-2.5">
                ...
                <p>O horário será liberado imediatamente no sistema e os lembretes automáticos serão desativados.</p>
              </div>
